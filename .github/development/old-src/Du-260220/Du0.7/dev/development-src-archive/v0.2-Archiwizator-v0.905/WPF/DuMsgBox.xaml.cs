...
namespace Du
{
    public partial class MsgBox : Window
    {
        ...
        // DEFAULT CONSTRUCTOR
        public MsgBox() => InitializeComponent();
        ...
        private void SetBoxHeight(MsgBox msgBox) => Height = msgBox.BoxHeight switch
        {
            < 250 => 250,
            > 500 => 500,
            _ => msgBox.BoxHeight,
        ...
        private void SetBoxWidth(MsgBox msgBox) => Width = msgBox.BoxWidth switch
        {
            < 350 => 350,
            > 600 => 600,
            _ => msgBox.BoxWidth,
        ...
        private void SetMsgTitle(MsgBox msgBox) => lblMsgTitle.Content = msgBox.MsgTitle == ""
        ...
        private void SetMsgBody(MsgBox msgBox) => lblMsgBody.Content = msgBox.MsgBody == ""
