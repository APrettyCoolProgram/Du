...
namespace Du
{
    public class DuJson
    {
        public static void SaveToFile<JsonObjectForDu>(string filePath, JsonObjectForDu jsonObject, bool formatJson)
        {
        ...
        //        File.WriteAllText("tester.test", JsonSerializer.Serialize<jsonObject>(initializeGameDetails));
        //    }
        ...
        //    //File.WriteAllText("tester.test", JsonSerializer.Serialize<Game>(initializeGameDetails));
        }

        public string SerializeNoFormatting<JsonObjectForDu>(JsonObjectForDu jsonObject)
        {
            return JsonSerializer.Serialize<JsonObjectForDu>(jsonObject);
        }




        #region DEPRECIATED_CODE

        /* This code requires Json.NET, which was used prior to Du being migrated to .NET Core 3.0.
         *
         * DuJson now uses System.Text.Json
         *
         */
