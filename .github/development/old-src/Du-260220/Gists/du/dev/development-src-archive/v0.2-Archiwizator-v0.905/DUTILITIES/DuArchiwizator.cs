...
namespace Du
{
    public class DuArchiwizator
    {
        ...
        public static void Refresh(Label progressLabel)
        {
        ...
        /// <returns></returns>
        private static List<string> GetListOfDirectories(string directoryList) => directoryList != ""
