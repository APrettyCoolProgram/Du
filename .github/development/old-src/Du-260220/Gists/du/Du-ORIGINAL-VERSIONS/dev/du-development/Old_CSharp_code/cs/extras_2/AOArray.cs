...
namespace AO
{
    public class AOArray
    {
        ...
        /// <param name="dataToWrite">The array that contains the data to write.</param>
        ...
        /// <param name="delimiter">The delimiter used to seperate keys and values (example: ",", "\t").</param>
        /// <param name="innerArraySize">The number of elements in the inner arrays.</param>
        /// <returns>A multi-dimentional array with the array contents.</returns>
        public static string[,] AsMultiDimentionalArray(string[] arrayToConvert, char delimiter, int innerArraySize)
        {
            ...
            foreach (var outerElement in arrayToConvert)
            {
                ...
                foreach (var innerElement in innerElements)
                {
                    ...
                    wrkMasterArray[masterArrayOuter, masterArrayInner] = innerElement; // [7]
                    // Inc
                    masterArrayInner++;
                }
                // Inc
        ...
        /// <summary>Counts the number of a specific something in an array.</summary>
        /// <param name="arrayToCount">Array to count.</param>
        /// <param name="itemtype">The item type to count [characters/lines].</param>
        /// <returns>The number of the specified somethings in the array.</returns>
        ...
        /// <param name="arraysToJoin">A list of arrays to join.</param>
        /// <param name="joinType">Type of join [concat/union].</param>
        /// <returns>The joined arrays.</returns>
        public static string[] Join(List<string[]> arraysToJoin, string joinType)
        {
            ...
            foreach (var item in arraysToJoin)
            {
                ...
                AOArray.Resize(wrkArray, item.Length);
