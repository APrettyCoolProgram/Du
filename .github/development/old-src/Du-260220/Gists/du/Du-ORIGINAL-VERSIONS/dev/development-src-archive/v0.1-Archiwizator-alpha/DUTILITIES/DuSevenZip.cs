...
namespace Du
{
    public class DuSevenZip
    {
        ...
        /// <summary></summary>
        /// <param name="sevenZip"></param>
        public static void Compress(DuSevenZip sevenZip)
        {
        ...
        /// <summary></summary>
        /// <param name="sevenZip"></param>
        public static void CompressDirectory(DuSevenZip sevenZip)
        {
        }
        ...
        {
            var sevenZipCommand = $"x \"{sourcePath}\" -o\"{destinationPath}\"";
        ...
        {
            return DuOperatingSystem.MSWindows.Is64Bit()
