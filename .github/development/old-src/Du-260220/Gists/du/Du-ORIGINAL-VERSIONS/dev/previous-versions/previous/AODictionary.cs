...
namespace AO
{
    public class AODictionary
    {
        ...
        public static string AsString(Dictionary<string, string> dictionaryToConvert, char delimiter)
        {
            /* Put cleaning here, or in it's own place? */
        ...
        public static Dictionary<string, string> Clean(Dictionary<string, string> dictionaryToClean, bool checkIsEmpty, bool checkIsComment, char commentChar, bool nullVal)
        {
            ...
            {
                if (AOString.Check(item.Key, checkIsEmpty, commentChar) && !nullVal && Convert.ToBoolean(item.Key == null))
                {
